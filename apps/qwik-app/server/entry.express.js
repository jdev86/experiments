...
const distDir = path.join(Url.fileURLToPath(typeof document === "undefined" ? new (require("url")).URL("file:" + __filename).href : document.currentScript && document.currentScript.src || new URL("entry.express.js", document.baseURI).href), "..", "..", "dist");
const buildDir = path.join(distDir, "build");
const { router, notFound } = qwikCity(render);
const app = express__default["default"]();
app.use(`/build`, express__default["default"].static(buildDir, {
  immutable: true,
  maxAge: "1y"
}));
app.use(express__default["default"].static(distDir, {
  redirect: false
}));
app.use(router);
app.use(notFound);
